      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            ...
            injectCss(link, link.href.split("?")[0] + "?unix=1580535920612");
          });
      }
    }
    ...
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1580535461052");
          });
      }
    }
    ...
    if (true) {
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1580535920644");
          });
      }
    }
...
// extracted by mini-css-extract-plugin
module.exports = {"Layout":"Layout___6G3ix","MainWrapper":"MainWrapper___3aD2G","Resume":"Resume___8AR-q","Header":"Header___1dv_e","Main":"Main___3yLoF","Bold":"Bold___1M7Vb","MobileContact":"MobileContact___1BSxw","DesktopContact":"DesktopContact___me_UM","Pink":"Pink___3v7_h","Green":"Green___7crE2","Blue":"Blue___1LIFm","Sidebar":"Sidebar___zMA2p"};;
    if (true) {
      var injectCss = function injectCss(prev, href) {
        var link = prev.cloneNode();
        link.href = href;
      ...
      if (window.__webpack_reload_css__) {
        ...
        document
          ...
          .forEach(function(link) {
            if (!link.href.match(prefix) || link.stale) return;
            injectCss(link, link.href.split("?")[0] + "?unix=1580536047476");
          });
      }
    }
